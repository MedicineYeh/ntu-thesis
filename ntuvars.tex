...
%\setCJKmainfont[AutoFakeBold=3, AutoFakeSlant=.3]{cwTeXKai} % Free CJK Font
%\setCJKmainfont[AutoFakeBold=3, AutoFakeSlant=.3]{AR PL UKai TW} % Free CJK Font
\fi
